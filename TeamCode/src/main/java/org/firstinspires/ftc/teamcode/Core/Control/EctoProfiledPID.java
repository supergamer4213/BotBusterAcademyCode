...
public class EctoProfiledPID {
    private static int instances;

    private EctoPID m_controller;
    ...
    public EctoProfiledPID(
        ...
        m_controller = new EctoPID(Kp, Ki, Kd, period);
    ...
    public double calculate(double measurement) {
        if (m_controller.isContinuousInputEnabled()) {
            ...
            double goalMinDistance =
                    EctoMath.inputModulus(m_goal.position - measurement, -errorBound, errorBound);
            double setpointMinDistance =
                    EctoMath.inputModulus(m_setpoint.position - measurement, -errorBound, errorBound);
